...
struct SampleColorView: View {
    ...
    @State var items = [
        ...
        SampleColor(name: "mainpink_dark" , color: .mainpink_dark),
        SampleColor(name: "mainpink" , color: .mainpink),
        SampleColor(name: "mainpink_light" , color: .mainpink_light),
        ...
        SampleColor(name: "purple_light" , color: .purple_light),
        SampleColor(name: "green" , color: .green),
        SampleColor(name: "green_light2" , color: .green_light2),
        SampleColor(name: "green_light" , color: .green_light),
